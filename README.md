# did:cndomain
 ...
 `did:cndomain` is a DID method anchored to the `.cn` domain namespace.
 ...
 Draft for DID method registration preparation.
 ...
 This repository is document-first and focuses on method specification and registration materials.
